    ...
    def __init__(self, state_len : int, 
        ...
        if not use_one_hot:
            self.input_layer = keras.models.Sequential([
                ...
                LearnablePE(embed_size, state_len=state_len, dropout=dropout_rate) if positional_embedding == "learnable" 
                else PositionalEmbedding(embed_size, state_len=state_len, dropout=dropout_rate)
            ],name="input_layer")
